...
class _SellerProfileState extends State<SellerProfile>
  ...
  removeFromCart(int index) async {
    ...
    if (_isNetworkAvail) {
      if (CUR_USERID != null) {
        ...
        if (persistentBottomSheetController != null && getQuantity() == '1') {
          print(getQuantity());
        ...
        //   // if (persistentBottomSheetController != null && getQuantity() == '0') {
        //   //   print(getQuantity());
        //   //   Navigator.of(context).pop();
        //   // }
              ...
              child: InkWell(
                onTap: () {
                  if (_isProgress == false) {
                    ...
                    // applyVarient(model, index, addIdList.toList());
  ...
  showBottomWithoutAddOn(Product model, int index) async {
    bool? available, outOfStock;
    addIdList.clear();
    int? selectIndex = 0;
    //selList--selected list
                  ...
                  !loading
                    ...
                    child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                                "${getQuantity()} Item Added", //  "Item total ${CUR_CURRENCY! + priceAdd.toString()}",
                                textAlign: TextAlign.center,
                                style: Theme.of(context)
                                    .textTheme
                                    .button!
  ...
  String getQuantity() {
    ...
    for (var i = 0; i < _controller.length; i++) {
      if (int.parse(_controller[i].text) > 0) {
        total = total +
            (int.parse(_controller[i].text) +
