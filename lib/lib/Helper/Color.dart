...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xffE53422);
  static const Color secondary = Color(0xffF58B20);
  ...
  static const Color grad1Color = Color(0xffE53422);
  static Color grad2Color = Color(0xffE53422).withOpacity(0.6);
